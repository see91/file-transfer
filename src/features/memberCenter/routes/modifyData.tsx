...
export const ModifyData = () => {
  ...
  const submitHandler = async () => {
    ...
    let data = {
      nickname: nickname, //inputRefNickname.current?.input?.value,
      userSite: userSite, //inputRefUserSite.current?.input?.value,
      ...
      personalProfile: profile, //textAreaRefProfile.current?.resizableTextArea?.textArea.value,
    };
    ...
    await sendMessageSync("updateUserInfo", data);
